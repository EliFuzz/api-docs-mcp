  ...
  'api_docs',
  {
    ...
    inputSchema: {
      sourceName: z
        .string()
        .describe(
          'The name of the API source (e.g., "GitHub") from MCP configuration environment variables. If not provided, docs from all sources will be returned.'
        )
        .optional(),
      resourceType: z
        .enum(ResourceType)
        .describe(
          'The type of the API resource. If provided, only resources of this type will be returned.'
        )
        .optional(),
    },
    outputSchema: {
        ...
        z.object({
          ...
          resources: z.array(
            z.object({
              resourceType: z
                .enum(ResourceType)
                .describe('The type of the API resource'),
              resourceName: z.string().describe('The name of the API resource'),
              resourceDescription: z
                .string()
                .describe('A brief description of the API resource'),
            })
          ),
        })
      ),
